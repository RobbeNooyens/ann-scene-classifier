...
def main():
    ...
    # Black and White Perturbation pretext overfitted Pretext Task
    ...
    # ======== Train and evaluate pretext model ========
    perturbation_pretext_model = ModelManager(PERTURBATION_CONFIG)
    perturbation_pretext_model.train_model(perturbation_train_loader, perturbation_valid_loader)
    perturbation_pretext_model.evaluate_test_set(perturbation_test_loader)
    # ======== Train and evaluate scene model ========
    perturbation_scenes_model = ModelManager(PERTURBATION_SCENES_CONFIG)
    perturbation_scenes_model.train_model_pre_load(train_loader, valid_loader)
    perturbation_scenes_model.evaluate_test_set(test_loader)
